      ...
      <section className="text-gray-600 body-font max-w-6xl">
        <div className="container mx-auto flex px-5  md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <p className="mb-8 leading-relaxed">Save your precise time with the help of our service. No need to search and call to check for the availability of the EV charging stations</p>
      ...
      <section className="text-gray-600 body-font max-w-6xl">
        <div className="container mx-auto flex px-5  md:flex-row flex-col items-center">
          ...
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
            ...
            <p className="mb-8 leading-relaxed">make it more convenient to find the EV station. Get the details of the charging station.</p>
            <div className="flex justify-center">
              <a
                href="#"
                className="rounded-md bg-green-100 text-green-400 px-3.5 py-2.5 text-sm font-semibold  shadow-sm hover:bg-green-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 0"
